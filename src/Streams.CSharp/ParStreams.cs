...
namespace Nessos.Streams.CSharp
{
    ...
    public static class ParStreams
    {
        ...
        /// <summary>Computes the average of the integer projections given by the supplied function on the input parallel stream.</summary>
        /// <param name="source">The input parallel stream.</param>
        /// <param name="projection">A function to transform items of the input parallel stream into a projection.</param>
        /// <returns>The computed average.</returns>
        /// <exception cref="System.ArgumentException">Thrown if the input parallel stream is empty.</exception>
        public static double Average<T>(this ParStream<T> source, Func<T, int> projection)
        {
            return CSharpProxy.Average(source, projection);
        }

        /// <summary>Computes the average of the long integer projections given by the supplied function on the input parallel stream.</summary>
        /// <param name="source">The input parallel stream.</param>
        /// <param name="projection">A function to transform items of the input parallel stream into a projection.</param>
        /// <returns>The computed average.</returns>
        /// <exception cref="System.ArgumentException">Thrown if the input parallel stream is empty.</exception>
        public static double Average<T>(this ParStream<T> source, Func<T, Int64> projection)
        {
            return CSharpProxy.Average(source, projection);
        }

        /// <summary>Computes the average of the float projections given by the supplied function on the input parallel stream.</summary>
        /// <param name="source">The input parallel stream.</param>
        /// <param name="projection">A function to transform items of the input parallel stream into a projection.</param>
        /// <returns>The computed average.</returns>
        /// <exception cref="System.ArgumentException">Thrown if the input parallel stream is empty.</exception>
        ...
        /// <summary>Computes the average of the double projections given by the supplied function on the input parallel stream.</summary>
        /// <param name="source">The input parallel stream.</param>
        /// <param name="projection">A function to transform items of the input parallel stream into a projection.</param>
        /// <returns>The computed average.</returns>
        /// <exception cref="System.ArgumentException">Thrown if the input parallel stream is empty.</exception>
        ...
        /// <summary>Computes the average of the decimal projections given by the supplied function on the input parallel stream.</summary>
        /// <param name="source">The input parallel stream.</param>
        /// <param name="projection">A function to transform items of the input parallel stream into a projection.</param>
        /// <returns>The computed average.</returns>
        /// <exception cref="System.ArgumentException">Thrown if the input parallel stream is empty.</exception>
