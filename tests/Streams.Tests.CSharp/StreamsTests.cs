    ...
    public class StreamsTests
    {
            ...
            Spec.ForAny<int[]>((int[] xs) =>
                {
                    ...
                    {
                        var x = xs.AsStream().Reduce((l, r) => l + r);
        ...
        public void AverageBy()
        {
            Spec.ForAny<int[]>((int[] xs) =>
            {
                ...
                {
                    var x = xs.AsStream().Average(z => z);
                    var y = xs.Average(z => z);
                    return x == y;
                }
            }).QuickCheckThrowOnFailure();
        }
